export interface HangmanEntry { word: string; hint: string; }

export const HANGMAN_TIERS: HangmanEntry[][] = [
  [
...
export function pickRandomWord(tierIndex: number, avoidWord: string | null = null): HangmanEntry {
...
export function maxWrongForTier(tierIndex: number): number {
