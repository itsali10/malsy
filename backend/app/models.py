...
class User(Base):
    ...
    guardian_gender: Mapped[str] = mapped_column(String(20), nullable=False)
    guardian_email: Mapped[str] = mapped_column(String(150), nullable=False)
    guardian_phone_number: Mapped[str] = mapped_column(String(20), nullable=False)
